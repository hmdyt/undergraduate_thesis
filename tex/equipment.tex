...
\subsection{MPPC}
光検出器として, MPPC(Multi Pixel Photon Counter)を用いた. \cite{mppc}
...
最大64chのMPPCへの電圧の印加や同時読み出しが可能である. \cite{easiroc}
...
\end{equation}
である.
DACの入力を調整することで各MPPCへのBias Voltageを調整した.
...
完全にゲインを揃えることはできなかったが, おおよそ揃えることができた.
\begin{figure}[H]
    \begin{minipage}[b]{0.47\linewidth}
        \centering
